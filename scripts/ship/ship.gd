...
var eff_docking_time_mult: float
...
func get_effective_docking_time_mult() -> float:
	return eff_docking_time_mult
...
func _refresh_effective_stats() -> void:
	...
	eff_docking_time_mult = max(aggr.compute_for_context(Stat.DOCKING_TIME_MULT, 1.0, StatAggregator.Context.PLAYER), 0.0)
